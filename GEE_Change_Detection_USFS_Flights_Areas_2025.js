...
var yearlyNDVI = years.map(function(year) {
  ...
  var composite = collectionForYear.median();
  ...
  return finalResultImage
    ...
    .set('has_data_in_polygons', resultHasData)
    .set('composite_band_names_pre_clip', composite.bandNames())
...
// --- 8. NDVI TREND PLOT (Time-Series Chart) ---
...
// --- 9. EXPORT NDVI RESULTS AS GEOTIFFS ---
